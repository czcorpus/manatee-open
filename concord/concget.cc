...
bool KWICLines::nextline () {
    ...
    for (Labels::const_iterator i = lab.upper_bound(0);
        ...
        string collnum = to_string(i->first).insert(0, "coll");
        ...
        events.push_back (pos_event (ev_BTAG, p, 1000, collnum.c_str()));
        events.push_back (pos_event (ev_ETAG, pe, p==pe ? 2000 : -1000, collnum.c_str()));
