...
typedef std::shared_ptr<char> heapstr;
typedef DynFun_1<int> DynFun_i;
typedef DynFun_1<char> DynFun_c;
typedef DynFun_1<heapstr> DynFun_s;
typedef DynFun_2<int, int> DynFun_ii;
typedef DynFun_2<int, char> DynFun_ic;
typedef DynFun_2<int, heapstr> DynFun_is;
typedef DynFun_2<char, int> DynFun_ci;
typedef DynFun_2<char, char> DynFun_cc;
typedef DynFun_2<char, heapstr> DynFun_cs;
typedef DynFun_2<heapstr, int> DynFun_si;
typedef DynFun_2<heapstr, char> DynFun_sc;
typedef DynFun_2<heapstr, heapstr> DynFun_ss;

#define copystr(X) heapstr(strdup(X), std::free)
                      ...
                      const char *funname, ...)
{
    ...
    if (type[1] == '\0') {
        ...
        switch (type[0]) {
        case 's':
            return new DynFun_s (libpath, funname, copystr (arg1));
        case 'i':
        ...
        case 's':
            ...
            case 's':
                return new DynFun_ss (libpath, funname, 
                                      copystr (arg1), copystr (arg2));
            case 'i':
                return new DynFun_si (libpath, funname, 
                                      copystr (arg1), atol (arg2));
            case 'c':
        ...
        case 'c':
            switch (type[1]) {
            case 's':
                return new DynFun_cs (libpath, funname, arg1[0], copystr (arg2));
            case 'i':
